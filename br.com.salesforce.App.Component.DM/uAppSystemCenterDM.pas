...
begin
      //MELHOR TRABALHAR ESSA VINCULAÇÃO PELO CÓDIGO, CERTOS AJUSTES FUNIONAM MELHOR VIA O OBJECT INSPECTOR...
      //dsClientesBaseList.DataSet:= mmTableClientesBaseList;
end;

procedure TdmAppSystemCenter.ShowModalViewForm(T: TFormClass; F: TForm);
//#### ATENÇÃO MÉTODO GENÉRICO... CRIA UM SHOW MODAL
begin
    try
...
//#### ATENÇÃO MÉTODO GENÉRICO... CRIA APENAS O SHOW..
begin
    try
      Application.CreateForm(T,F);
      F.Show;
...
procedure TdmAppSystemCenter.GlobalAppDbasePath;
  // LÊ CAMINHO NA .INI E PASSA PARA A V GLOBAL.
begin
