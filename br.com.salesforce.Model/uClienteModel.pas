...
type
  ...
  private
    ...
    function GetAcao: TActionRotulo;                //GET EXPLÍCITO..
    procedure SetAcao(const Value: TActionRotulo);  //SET EXPLÍCITO..

    function GetCodigo: Integer;                    //GET EXPLÍCITO..
    procedure SetCodigo(const Value: Integer);     //SET EXPLÍCITO..

    function GetNome: string;                      //GET EXPLÍCITO..
    procedure SetNome(const Value: string);       //SET EXPLÍCITO..
