...
begin
    ...
    //PARA SÓ UTIIZAR ESSE MÉTODO CASO EXISTAM ALTERAÇÕES..!!
...
begin
    try
      ...
      Self.ReloadPathDbase;//AQUI FOI CENTRALIZADO P/ NO CASO DO PATH BD SER ALTERADO NÃO SER NECESSÁRIO REINICIAR APP DO ZERO..
      Result := VQuery;
    except
