...
//O MARCADOR / CARIMBO DA ## ALTERAÇÃO ## FOI DEFINIDA AO SELECIONAR O BOTÃO ALTERAR ABAIXO!!!!
begin
    if NOT (Self.EditValidator) then //SE ESTIVER VAZIO NO CAMPO DE NOME.. VALIDADOR SIMPLES..
      ...
      begin
        //ESSE AQUI NÃO É UTILIZADO EM CASO DE NOVO REGISTRO...
        FControllerCliente.ClienteModel.Codigo:= StrToInt(edtCodigo.Text);// MAS É UTILIZADO EM CASO DE USAR CARIMBO DE EDIÇÃO...
