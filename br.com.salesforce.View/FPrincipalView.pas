...
begin
    dmAppSystemCenter.Destroy;//USADO AQUI PARA EVITAR RESTOS DE MEMÓRIA NÃO LIBERADA... AO USAR dmAppSystemCenter.APathDBase
...
begin
    ...
    //NÃO FUNCIONA COM USO CONCATENADO DO PATH DE BANCO...
