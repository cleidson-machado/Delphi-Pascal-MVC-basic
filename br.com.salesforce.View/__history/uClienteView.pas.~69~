...
type
  ...
  private
    ...
    VClienteController: TClienteController;// VARIÁVEL GLOBAL QUE ABRIGA A CLASSE CONTROLLER...
...
begin
  VClienteController.Free;// USAR TODAS NO PADRÃO FREE...

  //VClienteController.Destroy;

  //TSistemaControl.GetInstance.Destroy;//NÃO USER ISSO AQUI APENAS NA FORM PRINCIPAL
...
begin
    ...
    ShowMessage('NOME ENCONTRADO É:' + ' >> ' + VClienteController.ClienteModel.Nome );
