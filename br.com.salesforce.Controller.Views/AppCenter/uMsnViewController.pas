...
begin
     if (Application.MessageBox(PChar('VOCÊ CONFIRMA EXCLUIR O REGISTRO?'),
        'CONFIRMAÇÃO DE EXLUSÃO...', MB_YESNO + MB_DEFBUTTON2 + MB_ICONQUESTION) = mrYes) then
        begin
          Result:= True;
...
begin
    ShowMessage('UM DOS CAMPOS ESTÁ EM BRANCO, FAVOR VERIFICAR CAMPOS DESTACADOS...!!');
end;
